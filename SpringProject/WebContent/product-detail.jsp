      ...
      <div id="content">
        <div class="container">
          <div class="row bar">
            ...
            <div class="col-lg-9">
              <p class="lead">상세보기 / 수정</p>
             
              <div id="productMain" class="row">
                <div class="col-sm-6">
                  <div data-slider-id="1" class="owl-carousel shop-detail-carousel">
                    <div> <img src="files/${dto.image }" alt="" class="img-fluid"></div>
                ...
                <div class="col-sm-6">
                  ...
                  <div data-slider-id="1" class="owl-thumbs">
                    <button class="owl-thumb-item"><img src="files/${dto.image }" alt="" class="img-fluid"></button>
